            ...
            <AnimatePresence mode="wait">
                ...
                >
                    <TabsContent value="tab-1">
                        <div className="flex flex-col justify-center items-center w-64 gap-2 p-4">
                            <UsersIcon className="opacity-60" width={32} height={32} aria-hidden="true" />
                            <span className="text-sm text-gray-800 dark:text-gray-200 text-center">Followers</span>
                        </div>
                    </TabsContent>
                    <TabsContent value="tab-2">
                        <div className="flex flex-col justify-center items-center w-64 gap-2 p-4">
                            <ThumbsUpIcon className="opacity-60" width={32} height={32} aria-hidden="true" />
                            <span className="text-sm text-gray-800 dark:text-gray-200 text-center">Likes</span>
                        </div>
                    </TabsContent>
                    <TabsContent value="tab-3">
                    <div className="flex flex-col justify-center items-center w-64 gap-2 p-4">
                            <StarIcon className="opacity-60" width={32} height={32} aria-hidden="true" />
                            <span className="text-sm text-gray-800 dark:text-gray-200 text-center">Favorites</span>
                        </div>
                    </TabsContent>
                </motion.div>
            </AnimatePresence>
