        ...
        const updateDimensions = () => {
            if (currentTabRef.current) {
                setDimensions({
                    ...
                    height: currentTabRef.current.offsetHeight,
                    left: currentTabRef.current.offsetLeft,
                    top: currentTabRef.current.offsetTop
                });
            }
        };
        updateDimensions();
            ...
            <ScrollArea>
                <TabsList className="relative mb-3">
                    ...
                    <TabsTrigger ref={tab2Ref} value="tab-2" className="group z-10 data-[state=active]:bg-transparent border-0 flex flex-row items-center gap-2 transition-colors duration-500 delay-200">
                        ...
                        Likes
                        <Badge
                            className="bg-primary/15 min-w-5 px-1 transition-opacity group-data-[state=inactive]:opacity-50"
                            variant="secondary"
                        >
                            5
                        </Badge>
