...
function StepperTrigger({
  ...
  return (
    <Comp
      ...
      {...(!asChild
        ? { disabled: isDisabled }
        : { "aria-disabled": isDisabled, "data-disabled": isDisabled })}
      {...props}
    >
      {children}
    </Comp>
    ...
    >
      {asChild ? (
        ...
        <>
          ...
          <CheckIcon
            className="absolute scale-0 opacity-0 transition-all group-data-[state=completed]/step:duration-300 group-data-[state=completed]/step:delay-400 group-data-[state=completed]/step:scale-100 group-data-[state=completed]/step:opacity-100"
            size={16}
            aria-hidden="true"
          />
          {isLoading && (
...
function StepperSeparator({
  ...
  return (
    <div
      ...
      className={cn(
        "relative overflow-hidden m-0.5 bg-muted",
    ...
    >
      <div
        className={cn(
          ...
          "group-data-[orientation=horizontal]/stepper:group-data-[state=completed]/step:scale-x-100",
          // Vertical animation
          "group-data-[orientation=vertical]/stepper:origin-top group-data-[orientation=vertical]/stepper:scale-y-0",
          "group-data-[orientation=vertical]/stepper:group-data-[state=completed]/step:scale-y-100",
        )}
      />
    </div>
  );
